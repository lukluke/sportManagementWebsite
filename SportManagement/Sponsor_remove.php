                  ...
                  <nav>
                     ...
                     <ul class="nav navbar-nav navbar-right">
                        <li class="">
                           ...
                           <b><?php echo "Sponosr:"." ".$result['FirstName']." ".$result['LastName']; ?></b> <!--get Name-->
               ...
               <div class="">
                  <div class="page-title">
                     <div class="title_left">
                        <h3>View Sponsorship Records</h3>
                                    ...
                                    while($rc = mysqli_fetch_assoc($result)){
                                      ...
                                      if($rc['DateOfEvent'] >$today){
                                          ...
                                          echo "<td>{$rc['Gender']}</td>
                                                ...
                                                <td>{$rc['Name']}</td>   
                                                <td>{$rc['Amount']}</td>                                        
                                                <td><a href=\"Sponsor_delete.php?SponsorID=$SpID&RegID={$rc['RegID']}\">Cancel Sponship</a></td></tr>";
                                      }
