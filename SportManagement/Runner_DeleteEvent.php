 ...
 <link href="css/layout.css" rel="stylesheet">
    ...
    <link href="css/icon.css" rel="stylesheet">
     <title>Marathon Skills</title>
	   <script>
  function setValue(RegID) {
	document.getElementById('rID').value=RegID;
                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           ...
                           <li role="presentation" class="active"><a href="#tab_content3" role="tab" id="customer-tab" data-toggle="tab" aria-expanded="false">Delete Register</a></li>
                                  </ul>
                        ...
                        <th>Distance</th>
                                 ...
                                 <?php
									...
									$sql="SELECT * FROM eventregister, event WHERE eventregister.EventID=event.EventID AND eventregister.RunnerID='".$ID."'";
									$rs=mysqli_query($conn,$sql)or die(mysqli_connect_error());
                                    while($rc = mysqli_fetch_assoc($rs)){
                                    if(time()>$rc['DateOfEvent']){
                                       echo "<tr>
                                          <td>{$rc['RegID']}</td>
                    										  <td>{$rc['EventID']}</td>
                                          <td>{$rc['Name']}</td>
                                           ...
                                           <td>{$rc['Distance']}</td>
										                     ...
										                     echo "<td><input type='button' value='Delete Event' onclick='setValue(".$rc['RegID'].")'></td>";
                                          }
                                          
                                    }
								                      	echo "<input type='hidden' name='rID' id='rID' value=''/>";
                                 ?>
                                          </tbody>
                                       </table>
