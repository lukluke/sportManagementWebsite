 ...
 <link href="css/layout.css" rel="stylesheet">
   ...
   <body class="nav-md">
                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           ...
                           <li role="presentation" class="active"><a href="#tab_content3" role="tab" id="customer-tab" data-toggle="tab" aria-expanded="false">Send Race Kit</a></li>
                                  </ul>
                           <li
                                  </ul>
                              ...
                              <div id="airline"></div>
                                    ...
                                    <?php
                                       $sql ="select r.*,e.Name,e.EventID,e.Distance,er.CheckInTime,er.RegID,rk.Name as RaceKitName from Runner r ,Event e,EventRegister er ,RaceKitChoice rk
                                             where er.EventID = e.EventID and er.RunnerID = r.RunnerID and  er.RaceKitID = rk.RaceKitID and er.RunnerID = '$RunnerID' and er.EventID = '$EventID' ";
                                       $result = mysqli_query($conn,$sql);
                                        $result = mysqli_fetch_assoc($result);
                                  ...
                                  <div class="col-md-10">
                                             ...
                                             <div class="col-md-2">
                                                <div class="form-group"></br>
                                                   <label> Race Kit Name</label>
                                                    <input type="text" class="form-control" name="Disance" value="<?php echo  $result ['RaceKitName']?>" readonly>
                                  ...
                                  <div class="row">
                                          ...
                                          <div class="modal-footer">
                                            <button type="button" class="btn btn-info btn-fill pull-right" onclick="back();">Back</button>
                                              ...
                                              <button type="submit" class="btn btn-info btn-fill pull-right"  name="CheckIn">Sent Out</button>
                                          </div>
                                       </form>
                              ...
                              if(isset($_POST['CheckIn'])){
                                 extract($_POST);
                                    ...
                                    $today = date("h:i:sa"); //get today time
                                     ...
                                     $sql = "update EventRegister set `RaceKitSent` ='1' where EventID = '$EventID' and RunnerID ='$RunnerID' and RegID ='$RegID'"; // update customer information
                                     ...
                                     if(mysqli_affected_rows ($conn) == 1){
                                        ...
                                        echo "<script>alert('RaceKit Sent sucessful')</script>";
                                 
                                        echo "<script>window.location.href = \"./SendRaceKitList.php\"</script>";;
                                    
                                       
                                     }else{
                                       echo "<script>alert('RaceKit Sent Unsucessful')</script>";
      ...
      <!-- use ajax to get the data -->
        <script> 
      function back(){
         window.location.href = "./SendRaceKitList.php"
      }    
   </script>
   <!--Set Photo Format-->
