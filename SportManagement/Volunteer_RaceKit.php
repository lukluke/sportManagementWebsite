                                          ...
                                          <div class="row">
                                             <div class="col-md-6">
                                                <div class="form-group"></br>
                                                   ...
                                                   <input type="text" class="form-control" name="Name" placeholder="EventName" name="search_text" id="search_text">
                                                </div>
                                                </div>
                                             </div>
                                  <div class="row">
