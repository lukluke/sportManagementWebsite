                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           ...
                           <li role="presentation" class="active"><a href="#tab_content3" role="tab" id="customer-tab" data-toggle="tab" aria-expanded="false">Assign Runner to Volunteer</a></li>
                             <li role="presentation" class=""><a href="#tab_content2" role="tab" id="hotel-tab" data-toggle="tab" aria-expanded="false">Runner has Assigned</a></li>
                                  </ul>
                                         ...
                                         <thead>
                                             <tr>
                                                ...
                                                <th>Volunteer Name</th>
                                                 <th>Action--UnAssign</th>
                                                 
                                             </tr>
                                          </thead>
                                          <tbody>
                                 <?php
                                    // get all Runner and join volunteer table
                                    $sql = "select r.*,vol.FirstName as VfirstName,vol.LastName as VLastName from Runner r,Volunteer vol where r.VolunteerID = vol.VolunteerID and r.VolunteerID != 'NULL'";
                                    $result = mysqli_query($conn,$sql);
                                    while($rc = mysqli_fetch_assoc($result)){
                                       ...
                                       if($rc["ProfilePicture"] != null){
                                        ...
                                        echo'<td>'.$rc["VolunteerID"].'</td>';
                                        echo'<td>'.$rc["VfirstName"]." ".$rc["VLastName"].'</td>';
                                        echo '<td><a href="UnassignRunner.php?RunnerID='.$rc['RunnerID'].'">UnAssign Volunteer</a></td></tr>';
                                    }
                                 ?>
                                          </tbody>
                                       </table>
                                 ...
                                 <?php
                                    ...
                                    while($rc = mysqli_fetch_assoc($result)){
                                       ...
                                       if($rc["ProfilePicture"] != null){
                                        ...
                                        echo '<td>'.$rc['FirstName']." ".$rc['LastName'].'</td>';
                                        echo'<td>'.$rc["Gender"].'</td>';
                                        echo'<td>No Volunteer</td>';
                                        echo '<td><a href="Admin_Runner.php?action=update&id='.$rc['RunnerID'].'">Assign Volunteer</a></td></tr>';
                                    }
                                 ?>
                                          </tbody>
                                       </table>
                           ...
                           ?>
                               <form style="padding-left:20px" method="POST">
                                    <div class="row">
                                       <h3 style ="color :Brown">Runner Infromation : </h3> 
                                       <div class="col-md-2">
                                                <div class="form-group"></br>
                                                   <label></label>
                                                   <?php 
                                       ...
                                       <table class="data table table-striped no-margin">
                                         <h3 style ="color :Green;">Assign Volunteer List : </h3> 
                                         <thead>
                                             <tr>
                                                <th>Volunteer ID</td>
                                                <th>Name</th>         
                                    ...
                                    while($rc = mysqli_fetch_assoc($result)){
                                       echo "<tr>
                                          ...
                                          <td>{$rc['Email']}</td>
                                            ...
                                            <td><a href=\"selectVolunteer.php?VolunteerID={$rc['VolunteerID']} && RunnerID=$id\">Select Volunteer</a></td></tr>"
