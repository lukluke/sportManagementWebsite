                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           ...
                           <li role="presentation" class="active"><a href="#tab_content3" role="tab" id="customer-tab" data-toggle="tab" aria-expanded="false">Runner Event Record</a></li>
                                  </ul>
      ...
      <!-- use ajax to get the data -->
       <script>
         $(document).ready(function(){
             ...
             {
              $.ajax({
               url:"Volunteer_SearchRunner.php",
               method:"POST",
               data:{query:query},
